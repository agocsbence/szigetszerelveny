        ...
        <div class="container">
            <div class="row p-3">
                <div class="col-sm-12 col-lg-4">
                    <img src="<?php bloginfo('template_url') ?>/assets/img/logo-footer--white.png" alt="Sziget Szerelvény Kft." style="width: 130px;">
                </div>
                ...
                <div class="col-sm-12 col-lg-4 gy-4 gy-sm-0">
                    ...
                    <p><i class="text-info bi bi-envelope"></i> <a href="mailto:info@szigetszerelveny.hu">info@szigetszerelveny.hu</a></p>
                </div>
            </div>
        </div>
	</footer>
